...
`,
  ...
  'callback-on-mount': 'колбек события mount',
  'callback-on-unmount': 'колбек события unmount',
...
`,
  ...
  'option-fromViewportWidth': 'Минимальная ширина окна в пикселях, брейкпойнт при которой иммёрсер монтируется',
  'option-pagerThreshold': 'Доля высоты окна, которую следующий слой должен перекрыть перед переключением навигации',
  ...
  'option-debug': 'Включает логирование предупреждений. По умолчанию true в режиме разработки, иначе false',
