...
`,
  ...
  'public-field-mount':
    'Монтирует рантайм, если ширина окна проходит fromViewportWidth: ищет DOM, готовит разметку, рассчитывает размеры и навешивает слушатели',
  'public-field-unmount':
    'Размонтирует рантайм, очищает сгенерированную разметку и оставляет resize-обработчик для remount по брейкпоинту',
  ...
  'public-field-isMounted': 'Показывает, смонтирован ли рантайм',
